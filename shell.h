...
void print_syntax_error(data_sh *datash, char *input, int i, int bool);
int check_syntax_error(data_sh *datash, char *input);
...
void go_next(sep_list **list_s, line_list **list_l, data_sh *datash);
int split_commands(data_sh *datash, char *input);
char **split_line(char *input);

/* rep_var.c */
void check_env(r_var **h, char *in, data_sh *data);
int check_vars(r_var **h, char *in, char *st, data_sh *data);
char *replaced_input(r_var **head, char *input, char *new_input, int nlen);
char *rep_var(char *input, data_sh *datash);
...
int is_executable(data_sh *datash);
...
void cd_previous(data_sh *datash);
void cd_to_home(data_sh *datash);
...
char *error_get_cd(data_sh *datash);
...
char *error_path_126(data_sh *datash);
